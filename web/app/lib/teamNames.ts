...
const TEAM_NICKNAMES: Record<string, string> = {
  ...
  // NHL (full 32-team fixed league — worth a complete map; keys are the exact
  // DB name = placeName + " " + commonName from api-web.nhle.com's schedule feed,
  // accents/punctuation preserved. Verified 2026-08-06.)
  "Anaheim Ducks": "Ducks",
